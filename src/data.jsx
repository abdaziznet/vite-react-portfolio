...
export const certificate = [
  ...
  },
  {
    ...
    desc: "Redis Software fundamentals certification covering deployment setup, database configuration, data import strategies, and operational monitoring for enterprise installations.",
    date: "2025",
  ...
  },
  {
    ...
    img: CertRedis,
    title: "Redis JSON",
    desc: "Certified in Redis JSON for native JSON document storage and manipulation. Expertise in JSON indexing, document search, and building high-performance APIs with Redis as a JSON database.",
    date: "2025",
  ...
  },
  {
    ...
    desc: "Certified in Redis Query Engine for advanced data querying and analytics. Expertise in structured data queries, full-text search, aggregation pipelines, and complex query optimization for high-performance applications.",
    date: "2025",
  ...
  },
  {
    ...
    img: CertRedis,
    title: "Redis for AI",
    desc: "Certified in Redis as a vector database for AI applications. Expertise in semantic and vector search, embeddings integration, and building production-ready AI-powered search and recommendation systems.",
    date: "2025",
  ...
  },
  {
    ...
    img: CertRedis,
    title: "Redis Streams",
    desc: "Certified in Redis Streams for real-time data processing. Expertise in producer-consumer patterns, consumer group management, and production-ready stream architectures for scalable event-driven applications.",
    date: "2025",
  ...
  },
  {
    ...
    desc: "Certified in building Redis-powered JavaScript applications with focus on indexing, search capabilities, and stream processing. Skilled in Redis integration, performance optimization, and troubleshooting for Node.js environments.",
    date: "2025",
  ...
  },
  {
    ...
    desc: "Accredited in Apache Kafka and Confluent Platform fundamentals. Expertise in event streaming architecture, scalability patterns, and emerging technologies including KRaft consensus and Apache Flink integration.",
    date: "2025",
  ...
  },
  {
    ...
    desc: "Completed advanced Redis Software operations training including production configuration, durability strategies, security hardening, and performance monitoring. Skilled in migration planning and scalability optimization.",
    date: "2026",
  ...
  },
  {
    ...
    desc: "Certified Redis operator with expertise in deployment, configuration, and maintenance of Redis Software. Skilled in cluster management, performance optimization, and operational best practices.",
    date: "2026",
  ...
  },
  {
    ...
    desc: "Azure Redis certification covering cache to vector database capabilities, AI framework integration, and cloud deployment. Expertise in migration strategies and real-time application architecture on Azure.",
    date: "2026",
  ...
  },
  {
    id: 31,
    img: CertRedis,
    title: "Redis Partner Sales Associate",
    desc: "Completed Redis partner sales training with focus on enterprise solution positioning, technical architecture understanding, and cross-industry application storytelling.",
    date: "2026",
    url: "https://www.credential.net/9e55e880-de33-4f86-8a44-bf9d3ce44412?username=abdaziz",
  },
  {
    id: 32,
    img: CertRedis,
    title: "Redis Partner Technical Sales Associate",
    desc: "Certified in Redis cloud architecture and technical sales. Skilled in positioning Redis solutions for real-time performance challenges, including expertise in Redis Query Engine, Event Streaming, and AI-powered demonstrations.",
    date: "2026",
